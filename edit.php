...
$id = $_GET['id'];
 $sql = "select * from formtable where slno = '{$id}'";
        ...
        <div class="row">
            <div class="col-sm-5" id="f0">
                ...
                <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="sno" value="<?php echo $row['slno']; ?>" hidden>
                              </div>
                    <div class="form-group">
                        <label for="">NAME</label>
                        <input type="text" name="f1" class="form-control" value="<?php echo $row['name']; ?>">
                              </div>

                        <div class="form-group">
                        <label for="">AGE</label>
                        <input type="number" name="f2" class="form-control" value="<?php echo $row['age']; ?>">

                           </div>

                       <div class="form-group">
                        <label for="">CONTACT</label>
                        <input type="text" name="f3" class="form-control" value="<?php echo $row['contact']; ?>">
                          </div>
